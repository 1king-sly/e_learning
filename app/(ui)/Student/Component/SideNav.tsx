  ...
  return (
    <>
        ...
        <div className='md:text-sm '>
          {/* <ul><> */}
            <div className={clsx(`flex my-3 hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-center lg:justify-start md:p-2 md:px-3 gap-2 rounded-md w-full h-12`, {'bg-sky-100 text-blue-600': pathName === '/Student/Dashboard'})}>
            ...
            <div className={clsx(`flex my-3 hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-center lg:justify-start md:p-2 md:px-3 gap-2 rounded-md w-full h-12`, 
            {'bg-sky-100 text-blue-600': pathName === '/Student/Exams'})}>
            ...
            <div className={clsx(`flex my-3 hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-center lg:justify-start md:p-2 md:px-3 gap-2 rounded-md w-full h-12`, {'bg-sky-100 text-blue-600': pathName === '/Student/Notes'})}>
            ...
            <div className={clsx(`flex my-3 hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-center lg:justify-start md:p-2 md:px-3 gap-2 rounded-md w-full h-12`, {'bg-sky-100 text-blue-600': pathName === '/Student/Assignment'})}>
              ...
              <div className={clsx(`flex my-3 hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-center lg:justify-start md:p-2 md:px-3 gap-2 rounded-md w-full h-12`, {'bg-sky-100 text-blue-600': pathName === '/Student/Profile'})}>
