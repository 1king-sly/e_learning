            ...
            <table className='w-full'>
                <tbody className='flex-col mt-4 flex'>
                    <tr className='min-[426px]:justify-around flex bg-gray-100 py-2 w-full pr-2 items-center rounded-lg'>
                        ...
                        <td className='w-full flex gap-0.5 justify-end p-2 lg:rounded-md rounded-full'>
                        <TrashIcon className='h-5 w-5 md:h-4 md:w-4 lg:w-7 lg:h-7 cursor-pointer'> </TrashIcon></td>
                    </tr>
                </tbody>
            </table>
        </div>
