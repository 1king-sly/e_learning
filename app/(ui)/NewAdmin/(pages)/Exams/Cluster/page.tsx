    ...
    <>
      <div className='w-full min-h-screen flex flex-col items-center justify-center pb-40'>
        <div className='flex flex-col  items-center'>
          ...
          <h3 className='text-sky-300 max-[425px]:text-xs'>CREATE AN EXAM CLUSTER</h3>
        </div>
          ...
          <form  className='w-[80vw] flex flex-col gap-2' >
            <div className='w-full flex justify-center items-center flex-col gap-2'>
              <textarea
                ...
                id="title"
                title='title'
                placeholder='Exam Cluster Title'
            ...
            <div className='w-full md:w-2/5 flex items-center justify-center  mx-auto'>
