...
export default function SideNav() {
  return (
    <>
        <div className='p-8 pl-10 h-screen  w-4/5 font-semibold hidden sm:block md:flex-none md:justify-start md:p-2 md:px-3 gap-2 rounded-md'>
        <h1 className='text-3xl md:text-xs px-4 pt-4 hidden lg:block'>E LEARNING </h1>
        <div className='md:text-sm '>
          <ul>
            <div className='flex my-3'>
              <Link href="/NewAdmin/Dashboard"  className='inline-flex items-center md:p-2 md:px-3 hover:bg-sky-100 hover:text-blue-600 w-full rounded-md'>
            ...
            <div className='flex my-3'>
              <Link href="/NewAdmin/Student"  className='inline-flex items-center md:p-2 md:px-3 hover:bg-sky-100 hover:text-blue-600 w-full rounded-md'>
            ...
            <div className='flex my-3'>
              <Link href="/NewAdmin/Teachers"  className='inline-flex items-center md:p-2 md:px-3 hover:bg-sky-100 hover:text-blue-600 w-full rounded-md'>
            ...
            <div className='flex my-3'>
              <Link href="/"  className='inline-flex items-center md:p-2 md:px-3 hover:bg-sky-100 hover:text-blue-600 w-full rounded-md'>
            ...
            <div className='flex my-3'>
              <Link href="/NewAdmin/Exams"  className='inline-flex items-center md:p-2 md:px-3 hover:bg-sky-100 hover:text-blue-600 w-full rounded-md'>
